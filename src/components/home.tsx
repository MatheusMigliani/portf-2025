   ...
   import { FaLinkedin, FaGithub, FaArrowDown,FaCheck } from "react-icons/fa6";
   ...
   export function HomeSection() {
     ...
     const opacity = useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [1, 0.5, 0.5, 0]);
         ...
         >
           ...
           <div className="mb-8 ">
             ...
             <div className="flex flex-col items-center justify-center text-cen space-y-6">
               ...
               />
               <FaArrowDown className={`size-16 ${scrolling ? "animate-bounce transition-all ease-in-out" : ""}`} />
             </div>
           </div>
         </motion.div>
       </section>
